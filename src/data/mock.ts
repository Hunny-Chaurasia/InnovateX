...
export const MOCK_PROJECTS = [
  {
    ...
    team: [
      { name: 'Arjun Mehta', institution: 'IIT Bombay', type: 'College', role: 'Lead', avatar: 'AM' },
      { name: 'Sneha Patel', institution: 'BITS Pilani', type: 'College', role: 'Contributor', avatar: 'SP' },
      { name: 'Karan Nair', institution: 'Delhi Public School', type: 'School', role: 'Contributor', avatar: 'KN' },
      { name: 'Ria Das', institution: 'IIT Bombay', type: 'College', role: 'Contributor', avatar: 'RD' },
    ],
  },
  {
    id: 'proj2',
    ...
    team: [
      { name: 'Arjun Mehta', institution: 'IIT Bombay', type: 'College', role: 'Lead', avatar: 'AM' },
      { name: 'Dev Rathi', institution: 'NIT Surat', type: 'College', role: 'Contributor', avatar: 'DR' },
    ],
  },
];

export const MOCK_STUDENTS_FACULTY = [
  { id: 's1', name: 'Arjun Mehta', email: 'arjun@iitb.ac.in', virtualId: 'STU-2024-0042', status: 'Active', projects: 2, joinDate: 'Aug 2024', avatar: 'AM' },
  { id: 's2', name: 'Sneha Patel', email: 'sneha@bits.ac.in', virtualId: 'STU-2024-0051', status: 'Active', projects: 1, joinDate: 'Aug 2024', avatar: 'SP' },
  { id: 's3', name: 'Mihir Joshi', email: 'mihir@dtu.ac.in', virtualId: 'STU-2024-0063', status: 'Invited', projects: 0, joinDate: 'Sep 2024', avatar: 'MJ' },
  { id: 's4', name: 'Tanvi Shah', email: 'tanvi@iitb.ac.in', virtualId: 'STU-2024-0071', status: 'Active', projects: 3, joinDate: 'Jul 2024', avatar: 'TS' },
  { id: 's5', name: 'Rohan Verma', email: 'rohan@iitb.ac.in', virtualId: 'STU-2024-0088', status: 'Invited', projects: 0, joinDate: 'Sep 2024', avatar: 'RV' },
];
...
export const MOCK_MENTORS = [
  { id: 'men1', name: 'Dr. Priya Sharma', institution: 'DTU', domain: 'AI/ML, HealthTech', avatar: 'PS', projects: 9 },
  { id: 'men2', name: 'Prof. Rahul Bose', institution: 'IIT Kharagpur', domain: 'IoT, Hardware', avatar: 'RB', projects: 6 },
  { id: 'men3', name: 'Dr. Anita Roy', institution: 'IIM Ahmedabad', domain: 'FinTech, Strategy', avatar: 'AR', projects: 12 },
  { id: 'men4', name: 'Prof. Suresh Kumar', institution: 'BITS Hyderabad', domain: 'SaaS, Cloud', avatar: 'SK', projects: 7 },
];
