...
import { publishProblem } from '../../store/workflow';
...
export default function PostProblem() {
  ...
  const handlePublish = () => {
    ...
    setForm({ title: '', description: '', domain: '', csr: false });
    setTags([]);
    setTagInput('');
    setSubmitted(true);
  };
    ...
    return (
      <div className="p-6 max-w-2xl mx-auto flex flex-col items-center justify-center min-h-64 gap-4">
        ...
        <p className="text-sm text-center" style={{ color: 'var(--muted-foreground)' }}>
          Your problem is now live. Students can discover it and faculty can see it in their Problem Statements portal.
        </p>
