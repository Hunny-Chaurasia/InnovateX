          ...
          <Card key={p.id} className="p-5">
            ...
            <div className="flex items-center justify-between pt-3 border-t" style={{ borderColor: 'var(--border)' }}>
              ...
              <div className="flex gap-2">
                ...
                <Button variant="secondary" size="sm" onClick={() => toast(`Opening funding flow for "${p.title}"`, 'info')}>Fund</Button>
                <Button size="sm" onClick={() => toast(`Viewing details for "${p.title}"`, 'info')}>View</Button>
              </div>
            </div>
          </Card>
        ))}
